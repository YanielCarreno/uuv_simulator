...
#include <uuv_sensor_ros_plugins/FLSonar.hh>
#include <uuv_sensor_ros_plugins/SDFTool.hh>
...
//////////////////////////////////////////////////
uuv_sensor_ros_plugins_msgs::SonarStamped FLSonar::SonarRosMsg(const gazebo::physics::WorldPtr _world)
{
  this->UpdateData();

  uuv_sensor_ros_plugins_msgs::SonarStamped sonarOutput;
